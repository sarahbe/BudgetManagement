(function() {
    ...
    //Bu renkler black ile birebir aynı. Ama primary ve accent renkler aynı olamaz uyarısını aldatmak için yeni palet yaptık.
        $mdThemingProvider.definePalette('light-black', {
            '50': '373636',
            '100': '6a6868',
            '200': '8c8a8a',
            '300': '646464',
        ...
        triThemingProvider.theme('blackadisyo')
       .primaryPalette('black', {
           'default': '50'
       })
       .accentPalette('red', {
       ...
       .warnPalette('red');
        ...
        triThemingProvider.theme('lightblackadisyo')
      .primaryPalette('black', {
          'default': '100'
      })
      .accentPalette('light-black', {
          'default': 'A700'
      })
      .warnPalette('black', {
          'default': 'A200'
        ...
        .sidebarTheme('blackadisyo')
        .toolbarTheme('white-orange')
        .logoTheme('blackadisyo')
        .contentTheme('lightblackadisyo');
