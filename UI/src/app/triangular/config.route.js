(function () {
    ...
    function routeConfig($stateProvider) {
        ...
        .state('triangular-no-sidebar', {
            abstract: true,
            templateUrl: 'app/triangular/layouts/default/default-no-sidebar.tmpl.html',
            controller: 'DefaultLayoutController',
            controllerAs: 'layoutController'
        })
        ...
        .state('triangular.super-admin', {
            abstract: true,
            views: {
                sidebarLeft: {
                    templateUrl: 'app/lokantapp/admin/menu/admin-menu.tmpl.html',
        ...
        .state('triangular-no-sidebar.default', {
            abstract: true,
            views: {
                toolbar: {
                    templateUrl: 'app/triangular/components/toolbars/toolbar.tmpl.html',
