(function() {
    ...
    function WizardController($scope, $timeout) {
        ...
        function updateProgress() {
            ...
            // calculate percentage process for completing the wizardi
            var percent = Math.floor((fixedErrors / totalErrors) * 100);
             if (angular.isNumber(percent)&& percent>0)
            vm.progress = Math.floor((fixedErrors / totalErrors) * 100);
        }

        function setProgress(lokProgress) {
            vm.progress = lokProgress;
        }
