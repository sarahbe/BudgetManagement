(function() {
    ...
    /* @ngInject */
    function DefaultToolbarController($scope,$window, $rootScope,$mdDialog, $mdMedia, $translate, $state, $element, $filter, $mdUtil, $mdSidenav, $mdToast, $timeout, $document, triBreadcrumbsService, triSettings, triLayout, triAuthorization, triAuthenticationService, triMenu) {
        var vm = this;
        ...
        vm.currentUserName= triAuthorization.getUserName();
        ...
        function openSideNav(navID) {
          ...
          function logOut() {
              ...
              triAuthenticationService.removeToken();
              triMenu.refreshMenu();
        ...
        function feedback($event) {
             $mdDialog.show({
                ...
                controllerAs: 'vm',
                templateUrl: 'app/lokantapp/dashboards/feedback/feedback.dialog.tmpl.html',
                targetEvent: $event,
                locals: {
                    getFocus: false
                }
